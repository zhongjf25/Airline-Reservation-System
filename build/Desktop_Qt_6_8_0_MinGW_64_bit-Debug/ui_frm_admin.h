...
public:
    ...
    void setupUi(QMainWindow *Frm_Admin)
    {
        ...
        btn_add->setGeometry(QRect(870, 10, 92, 28));
        btn_search = new QPushButton(centralwidget);
        btn_search->setObjectName("btn_search");
        btn_search->setGeometry(QRect(980, 10, 92, 28));
        btn_delete = new QPushButton(centralwidget);
        btn_delete->setObjectName("btn_delete");
        btn_delete->setGeometry(QRect(870, 40, 92, 28));
