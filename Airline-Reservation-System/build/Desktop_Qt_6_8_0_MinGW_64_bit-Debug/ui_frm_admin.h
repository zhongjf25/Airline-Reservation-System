...
public:
    ...
    void setupUi(QMainWindow *Frm_Admin)
    {
        ...
        Frm_Admin->setMinimumSize(QSize(1200, 800));
        Frm_Admin->setMaximumSize(QSize(1200, 800));
        ...
        btn_reset = new QPushButton(page1);
        btn_reset->setObjectName("btn_reset");
        btn_reset->setGeometry(QRect(850, 0, 41, 28));
        btn_del = new QPushButton(page1);
        btn_del->setObjectName("btn_del");
        btn_del->setGeometry(QRect(900, 0, 41, 28));
        stackedWidget->addWidget(page1);
        page2 = new QWidget();
        page2->setObjectName("page2");
        purchaseInfoTable = new QTableWidget(page2);
        if (purchaseInfoTable->columnCount() < 13)
            purchaseInfoTable->setColumnCount(13);
        QTableWidgetItem *__qtablewidgetitem14 = new QTableWidgetItem();
        purchaseInfoTable->setHorizontalHeaderItem(0, __qtablewidgetitem14);
        QTableWidgetItem *__qtablewidgetitem15 = new QTableWidgetItem();
        purchaseInfoTable->setHorizontalHeaderItem(1, __qtablewidgetitem15);
        QTableWidgetItem *__qtablewidgetitem16 = new QTableWidgetItem();
        purchaseInfoTable->setHorizontalHeaderItem(2, __qtablewidgetitem16);
        QTableWidgetItem *__qtablewidgetitem17 = new QTableWidgetItem();
        purchaseInfoTable->setHorizontalHeaderItem(3, __qtablewidgetitem17);
        QTableWidgetItem *__qtablewidgetitem18 = new QTableWidgetItem();
        purchaseInfoTable->setHorizontalHeaderItem(4, __qtablewidgetitem18);
        QTableWidgetItem *__qtablewidgetitem19 = new QTableWidgetItem();
        purchaseInfoTable->setHorizontalHeaderItem(5, __qtablewidgetitem19);
        QTableWidgetItem *__qtablewidgetitem20 = new QTableWidgetItem();
        purchaseInfoTable->setHorizontalHeaderItem(6, __qtablewidgetitem20);
        QTableWidgetItem *__qtablewidgetitem21 = new QTableWidgetItem();
        purchaseInfoTable->setHorizontalHeaderItem(7, __qtablewidgetitem21);
        QTableWidgetItem *__qtablewidgetitem22 = new QTableWidgetItem();
        purchaseInfoTable->setHorizontalHeaderItem(8, __qtablewidgetitem22);
        QTableWidgetItem *__qtablewidgetitem23 = new QTableWidgetItem();
        purchaseInfoTable->setHorizontalHeaderItem(9, __qtablewidgetitem23);
        QTableWidgetItem *__qtablewidgetitem24 = new QTableWidgetItem();
        purchaseInfoTable->setHorizontalHeaderItem(10, __qtablewidgetitem24);
        QTableWidgetItem *__qtablewidgetitem25 = new QTableWidgetItem();
        purchaseInfoTable->setHorizontalHeaderItem(11, __qtablewidgetitem25);
        QTableWidgetItem *__qtablewidgetitem26 = new QTableWidgetItem();
        purchaseInfoTable->setHorizontalHeaderItem(12, __qtablewidgetitem26);
        purchaseInfoTable->setObjectName("purchaseInfoTable");
        purchaseInfoTable->setGeometry(QRect(0, 60, 961, 611));
        stackedWidget->addWidget(page2);
        page3 = new QWidget();
        page3->setObjectName("page3");
        lineEdit_addNumber = new QLineEdit(page3);
        lineEdit_addNumber->setObjectName("lineEdit_addNumber");
        lineEdit_addNumber->setGeometry(QRect(90, 110, 150, 28));
        lineEdit_addCompany = new QLineEdit(page3);
        lineEdit_addCompany->setObjectName("lineEdit_addCompany");
        lineEdit_addCompany->setGeometry(QRect(260, 110, 150, 28));
        lineEdit_addDeparture = new QLineEdit(page3);
        lineEdit_addDeparture->setObjectName("lineEdit_addDeparture");
        lineEdit_addDeparture->setGeometry(QRect(260, 160, 150, 28));
        lineEdit_addDestination = new QLineEdit(page3);
        lineEdit_addDestination->setObjectName("lineEdit_addDestination");
        lineEdit_addDestination->setGeometry(QRect(430, 160, 150, 28));
        dateEdit_addDate = new QDateEdit(page3);
        dateEdit_addDate->setObjectName("dateEdit_addDate");
        dateEdit_addDate->setGeometry(QRect(90, 160, 150, 28));
        dateEdit_addDate->setDateTime(QDateTime(QDate(2024, 11, 28), QTime(16, 0, 0)));
        dateEdit_addDate->setCalendarPopup(true);
        btn_add = new QPushButton(page3);
        btn_add->setObjectName("btn_add");
        btn_add->setGeometry(QRect(630, 260, 92, 28));
        timeEdit_Departure_time = new QTimeEdit(page3);
        timeEdit_Departure_time->setObjectName("timeEdit_Departure_time");
        timeEdit_Departure_time->setGeometry(QRect(100, 250, 118, 22));
        timeEdit_Destination_time = new QTimeEdit(page3);
        ...
        titile->setGeometry(QRect(450, 10, 371, 41));
        QFont font1;
        ...
        titile->setStyleSheet(QString::fromUtf8("font: 38pt \"\346\245\267\344\275\223\";\n"
"font-size: 38px;\n"
"font-weight: bold;\n"
"color: rgb(0, 0, 127);\n"
""));
    ...
    void retranslateUi(QMainWindow *Frm_Admin)
    {
        ...
        QTableWidgetItem *___qtablewidgetitem14 = purchaseInfoTable->horizontalHeaderItem(0);
        ___qtablewidgetitem14->setText(QCoreApplication::translate("Frm_Admin", "\350\256\242\345\215\225ID", nullptr));
        QTableWidgetItem *___qtablewidgetitem15 = purchaseInfoTable->horizontalHeaderItem(1);
        ___qtablewidgetitem15->setText(QCoreApplication::translate("Frm_Admin", "\344\271\260\345\256\266ID", nullptr));
        QTableWidgetItem *___qtablewidgetitem16 = purchaseInfoTable->horizontalHeaderItem(2);
        ___qtablewidgetitem16->setText(QCoreApplication::translate("Frm_Admin", "\350\210\252\347\217\255ID", nullptr));
        QTableWidgetItem *___qtablewidgetitem17 = purchaseInfoTable->horizontalHeaderItem(3);
        ___qtablewidgetitem17->setText(QCoreApplication::translate("Frm_Admin", "\350\210\252\347\217\255\345\217\267", nullptr));
        QTableWidgetItem *___qtablewidgetitem18 = purchaseInfoTable->horizontalHeaderItem(4);
        ___qtablewidgetitem18->setText(QCoreApplication::translate("Frm_Admin", "\350\210\252\345\217\270", nullptr));
        QTableWidgetItem *___qtablewidgetitem19 = purchaseInfoTable->horizontalHeaderItem(5);
        ___qtablewidgetitem19->setText(QCoreApplication::translate("Frm_Admin", "\346\227\245\346\234\237", nullptr));
        QTableWidgetItem *___qtablewidgetitem20 = purchaseInfoTable->horizontalHeaderItem(6);
        ___qtablewidgetitem20->setText(QCoreApplication::translate("Frm_Admin", "\345\207\272\345\217\221\345\234\260", nullptr));
        QTableWidgetItem *___qtablewidgetitem21 = purchaseInfoTable->horizontalHeaderItem(7);
        ___qtablewidgetitem21->setText(QCoreApplication::translate("Frm_Admin", "\346\212\265\350\276\276\345\234\260", nullptr));
        QTableWidgetItem *___qtablewidgetitem22 = purchaseInfoTable->horizontalHeaderItem(8);
        ___qtablewidgetitem22->setText(QCoreApplication::translate("Frm_Admin", "\345\207\272\345\217\221\346\227\266\351\227\264", nullptr));
        QTableWidgetItem *___qtablewidgetitem23 = purchaseInfoTable->horizontalHeaderItem(9);
        ___qtablewidgetitem23->setText(QCoreApplication::translate("Frm_Admin", "\346\212\265\350\276\276\346\227\266\351\227\264", nullptr));
        QTableWidgetItem *___qtablewidgetitem24 = purchaseInfoTable->horizontalHeaderItem(10);
        ___qtablewidgetitem24->setText(QCoreApplication::translate("Frm_Admin", "\350\256\242\345\215\225\344\273\267\346\240\274", nullptr));
        QTableWidgetItem *___qtablewidgetitem25 = purchaseInfoTable->horizontalHeaderItem(11);
        ___qtablewidgetitem25->setText(QCoreApplication::translate("Frm_Admin", "\350\210\261\344\275\215\347\261\273\345\236\213", nullptr));
        QTableWidgetItem *___qtablewidgetitem26 = purchaseInfoTable->horizontalHeaderItem(12);
        ___qtablewidgetitem26->setText(QCoreApplication::translate("Frm_Admin", "\344\271\260\345\256\266\345\247\223\345\220\215", nullptr));
