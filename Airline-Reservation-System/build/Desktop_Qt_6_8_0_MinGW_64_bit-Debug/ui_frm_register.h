...
public:
    ...
    void setupUi(QWidget *Frm_Register)
    {
        ...
        label = new QLabel(Frm_Register);
        label->setObjectName("label");
        label->setGeometry(QRect(120, 50, 121, 31));
        label->setStyleSheet(QString::fromUtf8("font-family: Arial;\n"
"font-size: 30px;\n"
"font-weight: bold;\n"
"color: rgb(0, 0, 127);\n"
"font: 28pt \"\346\245\267\344\275\223\";"));
    ...
    void retranslateUi(QWidget *Frm_Register)
    {
        ...
        label->setText(QCoreApplication::translate("Frm_Register", "sse\350\210\252\347\251\272", nullptr));
    } // retranslateUi
